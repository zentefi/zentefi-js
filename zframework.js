...
Language.getText = function(s)
{
    var text = Language.parseText(s);
    return Language.texts[text] ? Language.texts[text] : '';
};

Language.text = function(s)
{
    return Language.getText(s);
};
